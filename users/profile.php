...
$matriculationno=$_POST['matriculationno'];
$department=$_POST['department'];
$level=$_POST['level'];
$phonenumber=$_POST['phonenumber'];
$pincode=$_POST['pincode'];
$query=mysqli_query($bd, "update users set fullName='$fname',matriculationNo='$matriculationno',department='$department',Level='$level',phonenumber='$phonenumber',pincode='$pincode' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Matriculation</label>
 <div class="col-sm-4">
<input type="text" name="matriculationno" required="required" value="<?php echo htmlentities($row['matriculationNo']);?>" class="form-control">
</div>
...
<option value="<?php echo htmlentities($row['Level']);?>"><?php echo htmlentities($st=$row['Level']);?></option>
