...
<label class="col-sm-2 col-sm-2 control-label"><b>Level :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['level']);?></p>
              </div>
            </div>  

  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Course Code :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['coursecode']);?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>Course Title :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['coursetitle']);?></p>
              </div>
            </div>  

 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Course Lecturer :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['courselecturer']);?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>Academic Session :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['academicsession']);?></p>
              </div>
            </div>  

  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Date result was published :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['drp']);?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>Student's Department :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['sdep']);?></p>
              </div>
            </div> 
