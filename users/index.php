...
$query=mysqli_query($bd, "SELECT * FROM users WHERE userEmail='$email' and matriculationNo='$matriculation'");
$num=mysqli_fetch_array($query);
if($num>0)
{
mysqli_query($bd, "update users set password='$password' WHERE userEmail='$email' and matriculationNo='$matriculation' ");
$msg="Password Changed Successfully";

}
else
{
$errormsg="Invalid email id or Matriculation no";
}
}
?>
...
<html lang="en">
  <head>
    ...
    <title>CSC COMPLAINT REPORT PORTAL | Student Login</title>
...
<input type="text" name="matriculation" placeholder="matriculation No" autocomplete="off" class="form-control" required><br>
