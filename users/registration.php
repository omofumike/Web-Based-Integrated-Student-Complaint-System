...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($bd, "insert into users(fullName,userEmail,password,matriculationNo,status) values('$fullname','$email','$password','$matriculationno','$status')");
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" method="post">
		        ...
		        <p style="padding-left: 1%; color: blue">
		        	<?php if($msg){
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
		            ...
		            <input type="password" class="form-control" placeholder="Password" required="required" name="password"><br >
		             <input type="text" class="form-control" maxlength="13" name="matriculationno" placeholder="Matriculation No (e.g U2017/5570001)" required="required" autofocus>
		            <br>
